<?php
    ...
    echo '<select name= "minutes" style=" width: 150px; height: 30px; position: absolute; left: 100px; top: 150px">';
...
*/        
    ...
    echo '<p><input type="submit" name="reload" value="更新" style=" width: 50px; height: 30px; position: absolute; left: 460px; top: 470px"  />'."\n";
    echo $this->Form->end();
    ...
    if(isset($_GET['reload']))
    {
        ...
        echo '<img src=./img/Imgdir/'.$file_name.' title="アンケート結果" style="position:absolute;top:250px;left:10px;">'."\n";
